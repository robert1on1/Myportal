...
$(document).ready(function(){
	...
	if(hoverEffect){
		for(i=1;i<=num;i++){
			$('<style>#wrapper'+i+' div:hover{border: 1px #01d1fe solid;box-shadow: 0px 0px 5px #01d1fe;margin-left:4px;margin-top:4px;}</style>').appendTo('head');
		};
	};
